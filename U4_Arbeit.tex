...
\frame
{
  ...
  \begin{tikzpicture}
	...
	xlabel=Weg $s\rightarrow$,
	ylabel=Kraft $F\rightarrow$,
	xmin=0, xmax=10,
	ymin=0, ymax=6,
	xticklabels={},
	yticklabels={},
...
\frame
{
  \frametitle{Elastische Dehnung einer Schraubenfeder}
  \begin{tikzpicture}
    \begin{axis}[
	%axis x line=center,
	height=6cm,
	...
	\addplot [color=red, very thick, mark=x, domain=0:0.3] coordinates {
	(0,0)
    (0.033,0.10)
    (0.067,0.20)
    (0.101,0.30)
...
\end{block}
    ...
    \begin{figure}
\begin{tikzpicture}[roundnode/.style={circle, draw=green!60, fill=green!5, thick, minimum size=5mm}, line cap=round,line join=round, scale=0.35]
...
\shadedraw [inner color=black!20!white, outer color=black!50!white, draw=black] (8.,2.) circle (1.cm);
...
\node at (16,1) {$E_{pot}=0$, $E_{kin}=m\cdot g\cdot h$};
\shadedraw [inner color=black!20!white, outer color=black!50!white, draw=black] (8.,8.) circle (1.cm);
...
\node at (16,7.5) {$E_{pot}=m\cdot g\cdot h_1$};
\node at (16,6.0) {$E_{kin}=m\cdot g\left(h-h_1\right)$};
\shadedraw [inner color=black!20!white, outer color=black!50!white, draw=black] (8.,14.) circle (1.cm);
...
\node at (16,13) {$E_{pot}=m\cdot g\cdot h$, $E_{kin}=0$};
